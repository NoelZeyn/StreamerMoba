              ...
              <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse">
                  ...
                  <tbody class="divide-y divide-gray-100">
                    <tr v-for="(donation, index) in paginatedDonations" :key="donation.id"
                      ...
                      <td class="px-4 py-6">
                        <div class="flex flex-col">
                          <div class="flex items-center gap-2">
                            ...
                            <span v-if="donation.platform === 'saweria'"
                              class="text-[8px] px-1.5 py-0.5 rounded bg-orange-100 text-orange-600 font-bold uppercase">Saweria</span>
                            <span v-else-if="donation.platform === 'sociabuzz'"
                              class="text-[8px] px-1.5 py-0.5 rounded bg-blue-100 text-blue-600 font-bold uppercase">SociaBuzz</span>
                          </div>
                      ...
                      <td class="px-4 py-6">
                        ...
                        <span v-if="donation.external_id"
                          class="mt-1 inline-block text-[9px] font-bold bg-gray-100 text-gray-500 px-1.5 py-0.5 rounded">
                          Ref: {{ donation.external_id }}
                        </span>
                      </td>
                      <td class="px-4 py-6">
                        <div class="flex flex-col">
                      ...
                      <td class="px-4 py-6 text-center">
                        <div class="flex flex-col items-center gap-1">
                          <span
                            class="px-2 py-1 rounded-md bg-emerald-50 text-emerald-600 text-[10px] font-black uppercase">Success</span>
                          <span class="text-[9px] text-gray-400 font-medium">{{ formatTime(donation.created_at)
                            }}</span>
                        </div>
                      </td>
                    </tr>
          ...
          <div class="space-y-6">
            ...
            <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
              ...
              <div v-if="donations.length > 0" class="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                <div
                  class="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 font-black">
            ...
            <div class="bg-gray-900 p-6 rounded-2xl text-white shadow-xl relative overflow-hidden">
              ...
              <div class="grid grid-cols-2 gap-3">
                <button @click="refreshData"
                  ...
                  <i
                    class="fas fa-sync-alt mb-2 block text-blue-400 group-hover:rotate-180 transition-transform duration-500"></i>
                  <p class="text-[9px] font-bold uppercase tracking-widest text-blue-300">Refresh</p>
                </button>
                <a href="https://saweria.co" target="_blank"
                  class="bg-white/5 hover:bg-orange-500/20 p-4 rounded-xl text-center border border-white/10 transition-all group">
                ...
                <a href="https://sociabuzz.com" target="_blank"
                  class="bg-white/5 hover:bg-blue-500/20 p-4 rounded-xl text-center border border-white/10 transition-all group">
                  <i class="fas fa-external-link-alt mb-2 block text-blue-400"></i>
                  <p class="text-[9px] font-bold uppercase text-blue-300">SociaBuzz</p>
                </a>
              </div>
            </div>
          </div>
